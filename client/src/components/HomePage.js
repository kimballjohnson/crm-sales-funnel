...
function HomePage() {
    return(
        <div>
            <Container>
            <h1>CRM Sales Funnel</h1>
            
            <h2>I created this site using Rails on the backend and React on the frontend.</h2>

<h3>I created the database by importing the data from a CSV file into a test table. I then used the data from that table to populate my prospect and company relational tables.</h3>
